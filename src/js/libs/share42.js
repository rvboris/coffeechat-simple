    ...
    (function ($) {
        $(function () {
            $('div.share42init').each(function (idx) {
                ...
                var l = '';
                for (j = 0; j < s.length; j++) l += '<a rel="tooltip" style="display:inline-block;vertical-align:bottom;width:16px;height:16px;margin:0 6px 6px 0;padding:0;outline:none;background:url(' + f + 'icons.png) -' + 16 * j + 'px 0 no-repeat" href=' + s[j] + ' target="_blank"></a>';
