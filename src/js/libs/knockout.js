    ...
    (function (window, document, navigator, jQuery, undefined) {
        ! function (factory) {
            ...
            if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
                ...
                define(['exports', 'libs/jquery'], factory);
            } else {
                    ...
                    toggleDomNodeCssClass: function (node, classNames, shouldHaveClass) {
                        if (classNames) {
                            ...
                            ko.utils.arrayForEach(classNames.match(cssClassNameRegex), function (className) {
                                ...
                                if (indexOfClass >= 0) {
                                    if (!shouldHaveClass) currentClassNames.splice(indexOfClass, 1);
                                } else {
                                    if (shouldHaveClass) currentClassNames.push(className);
                                }
                            });
                ...
                'update': function (element, valueAccessor, allBindingsAccessor) {
                    ...
                    if (value) {
                        ...
                        for (var i = 0, j = value.length; i < j; i++) {
                            ...
                            if (arrayEntry && arrayEntry['_destroy'] && !includeDestroyed) continue;
            ...
            ko.templateRewriting = (function () {
                ...
                function constructMemoizedTagReplacement(dataBindAttributeValue, tagToRetain, templateEngine) {
                    ...
                    // extra indirection.
                    var applyBindingsToNextSiblingScript = "ko.__tr_ambtns(function($context,$element){return(function(){return{ " + rewrittenDataBindAttributeValue + " } })()})";
